...
.method protected varargs doInBackground([Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    iget-object v2, v2, Landroid/support/v4/print/PrintHelperKitkat$2;->val$imageFile:Landroid/net/Uri;

    const/16 v3, 0xdac

    invoke-static {v1, v2, v3}, Landroid/support/v4/print/PrintHelperKitkat;->access$300(Landroid/support/v4/print/PrintHelperKitkat;Landroid/net/Uri;I)Landroid/graphics/Bitmap;
    :try_end_0
...
.method protected onPostExecute(Landroid/graphics/Bitmap;)V
    ...
    iput-object p1, v3, Landroid/support/v4/print/PrintHelperKitkat$2;->mBitmap:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v2, v5}, Landroid/print/PrintDocumentAdapter$LayoutResultCallback;->onLayoutFailed(Ljava/lang/CharSequence;)V

    .line 386
    :goto_0
    iget-object v2, p0, Landroid/support/v4/print/PrintHelperKitkat$2$1;->this$1:Landroid/support/v4/print/PrintHelperKitkat$2;

    iput-object v5, v2, Landroid/support/v4/print/PrintHelperKitkat$2;->mLoadBitmap:Landroid/os/AsyncTask;
    ...
    iget-object v4, p0, Landroid/support/v4/print/PrintHelperKitkat$2$1;->this$1:Landroid/support/v4/print/PrintHelperKitkat$2;

    iget-object v4, v4, Landroid/support/v4/print/PrintHelperKitkat$2;->val$jobName:Ljava/lang/String;
